...
from isaaclab_tasks.core.lift.config.kuka_allegro import kuka_allegro_env_cfg as kuka_lift_cfg
...
FINGERTIP_LIST = kuka_lift_cfg.FINGERTIP_LIST
...
class KukaAllegroEmbodiment(EmbodimentBase):
    ...
    def __init__(
        ...
        self.action_config = kuka_lift_cfg.KukaAllegroRelJointPosActionCfg()
